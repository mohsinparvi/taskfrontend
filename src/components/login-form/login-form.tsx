    ...
    <div className=" w-full ">
      ...
      <div className="space-y-8 mt-6 ">
        ...
        <form action="" className="space-y-4" onSubmit={handleLoginUser}>
          <div className="space-y-2">
            <p className="text-base font-medium">Email or username</p>
            <input
              type="email"
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-4">
              ...
              />
              <p className="text-base font-normal">Keep me signed in</p>
            </div>
            <a href="" className="underline text-base font-medium text-black">
              Forgot password?
            </a>
          </div>
          {apiError && (
          ...
          <p className="text-base font-normal text-center text-[#3B4752]">
            Haven’t joined yet?{" "}
            <Link to="/signup" className="text-[#11161B] font-medium underline">
              Sign up
            </Link>
          </p>
        </form>
